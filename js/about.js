  ...
  axios.get('./data/about.json')
    .then(response => {
      ...
      data.experience.forEach(exp => {
        xpHTML += `<h3 class="has-text-weight-bold">${exp.poste}</h3><p class="is-size-7">${exp.organisation}</p><ul class="content" style="list-style-type: circle!important; padding-left: 16px;">`;
